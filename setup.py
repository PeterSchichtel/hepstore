...
setup(
    ...
    packages=[
        ...
        'hepstore.core.physics',
        'hepstore.core.physics.model',
        'hepstore.core.plotter',
        'hepstore.core.school',
        'hepstore.core.school.books',
        'hepstore.core.school.books.classification',
        'hepstore.core.school.books.regression',
        'hepstore.core.statistic',
        'hepstore.framework',
        'hepstore.framework.herwig7',
        'hepstore.framework.corsika',
    ...
    entry_points = {
        'console_scripts': [
            ...
            'hepstore-corsika        = hepstore.core.docker.corsika:main',
            'hepstore-hepmc2corsika  = hepstore.core.docker.hepmc2corsika:main',
