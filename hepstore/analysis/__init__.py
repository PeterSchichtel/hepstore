...
def run():
    ...
    parser.add_argument(      "--crossection",  default=[1.0,0.5], type=float, help="crossection for signal and background", nargs='+')
    ...
    parser.add_argument(      "--minimal_signal_efficieny", default=0.1, type=float, help="for ...")
